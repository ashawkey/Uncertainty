...
class Uncertainty:
    def __init__(self, s, symbols=None, verbose=True):
        ...
        self.forbidden_symbols = dir(sp) + ['lambda']
        self.local_dict = {}
        self.subs_dict = {}
...
if __name__ == "__main__":
    ...
    un = Uncertainty("m0*g*l**3/(4*lmbd*a*h**3)", verbose=True)

    un.set_value('m0', [1000.57,999.51,1001.24,1001.9,1002.08], 0.02, 0.001)
    un.set_value('g', [9.8])
    un.set_value('l', [24.99], 0.01, 0.01)
    un.set_value('lmbd', [0.32075,0.31985,0.31975,0.3191,0.31885], 0.001, 0.01)
